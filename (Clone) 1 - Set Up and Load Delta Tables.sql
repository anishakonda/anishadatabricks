...
-- MAGIC %python
-- MAGIC spark.sql("DESCRIBE EXTENDED sales_bronze")
...
-- MAGIC %python
-- MAGIC spark.sql("DESCRIBE CATALOG dbacademy")
...
-- MAGIC %python
-- MAGIC spark.sql("DESCRIBE SCHEMA IDENTIFIER(DA.schema_name)")
...
-- MAGIC %python
-- MAGIC spark.sql("DROP TABLE IF EXISTS users_bronze")
-- MAGIC
-- MAGIC spark.sql("CREATE TABLE users_bronze USING DELTA")
